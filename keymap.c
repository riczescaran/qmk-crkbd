...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMS] = LAYOUT_split_3x6_3_ex2(
        KC_NO,     KC_NO,   KC_UP,   KC_NO,   KC_PGUP,  KC_HOME,   KC_NO,             KC_NO,     KC_7,      KC_8,    KC_9,    KC_MINS, KC_EQL,  KC_BSPC,
        KC_NO,     KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,  KC_END,    KC_NO,             KC_NO,     KC_4,      KC_5,    KC_6,    KC_LBRC, KC_RBRC, KC_NO,
        KX_SFCP,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,                                   KC_1,      KC_2,    KC_3,    KC_GRV,  KC_BSLS, KC_NO,
                                              KC_NO,    QK_LLCK,   KC_SPC,            KC_ENT,    KC_NO,     KC_0
    ),

    [_SYSTEM] = LAYOUT_split_3x6_3_ex2(
        KC_NO,     KC_MUTE, KC_VOLD, KC_VOLU, KC_MRWD,  KC_MFFD,   KC_NO,             KC_NO,     KC_NO,     KC_NO,   KC_NO,   KC_NO,   KX_LOCK, KC_NO,
        KC_NO,     RGB_TOG, RGB_VAD, RGB_VAI, KC_NO,    KC_NO,     KC_NO,             KC_NO,     KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_SLEP, KC_NO,
        KC_NO,     KC_NO,   KC_BRID, KC_BRIU, KC_NO,    KC_NO,                                   KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
