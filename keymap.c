...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3_ex2(
        ...
        TD(TD_LSFT_CAPS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                 KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MO(_MEDIA),
                                            KC_LCTL, KC_LGUI, KC_SPC,      KC_ENT,  MO(_NUMS), KC_RALT
    ),

    [_NUMS] = LAYOUT_split_3x6_3_ex2(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NO,       KC_NO,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_TAB,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, KC_NO,
        TD(TD_LSFT_CAPS), KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                KC_NO,   KC_NO,   KC_MINS, KC_EQL,  KC_BSLS, KC_NO,
                                            KC_LCTL, KC_LGUI, KC_SPC,      KC_ENT,  KC_NO,   KC_RALT
    ),
